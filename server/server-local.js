...
import { dbOperations, initializeDatabase } from './database-local.js';
...
app.get('/health', (req, res) => {
  res.json({ 
    status: 'OK', 
    message: 'BankIM Local SQLite Test API is running',
...
// Start server
app.listen(PORT, () => {
  console.log('🚀 BankIM Local SQLite Test Server Starting...');
  console.log(`📡 Server running on http://localhost:${PORT}`);
  console.log(`🔍 Health check: http://localhost:${PORT}/health`);
  console.log(`📊 Database info: http://localhost:${PORT}/api/db-info`);
  console.log(`👥 Users API: http://localhost:${PORT}/api/users`);
  console.log(`🗄️ Database: SQLite (Local Testing)`);
  console.log('=====================================');
});
