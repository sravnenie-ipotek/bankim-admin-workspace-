...
## Repository Split Architecture

**Important**: This codebase is in transition between a monorepo structure and separated repositories. According to `REPOSITORIES_README.md`:

### Current State
This directory contains both frontend and backend code but is being split into:

### Target Repositories
- **Frontend**: `bankimOnlineAdmin_client` - React TypeScript application
  - **GitHub**: `https://github.com/MichaelMishaev/bankimOnlineAdmin_client`
  - **Technology**: React 18 + TypeScript, Vite, React Router DOM, CSS3, Multi-language (RU/EN/HE)
- **Backend**: `bankimOnlineAdmin` - Node.js Express API  
  - **GitHub**: `https://github.com/MichaelMishaev/bankimOnlineAdmin`
  - **Technology**: Node.js + Express, PostgreSQL (Railway), JWT Authentication, Multi-database Architecture
...
### Development Workflow for Split Repositories
...
- **Independent Development**: Teams can work separately without merge conflicts
- **Independent Scaling**: Frontend on CDN, Backend on servers
- **Separate CI/CD**: Faster build and test pipelines
- **Independent Deployment**: Different hosting solutions and rollback capability
...
**Backend Deployment:**
- **Railway**: Full-stack deployment (currently used)
