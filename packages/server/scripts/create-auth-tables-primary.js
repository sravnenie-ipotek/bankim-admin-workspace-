...
console.log('🔌 Using primary database connection:', primaryConfig.connectionString?.split('@')[1]);
...
async function createAuthTables() {
  ...
  try {
    console.log('🚀 Creating authentication tables in primary database...');
    ...
    console.log('✅ Authentication tables setup complete in primary database');
